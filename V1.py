...
def openData(name):
        if name.endswith("-2d.train.csv"):
            ...
            for i in range(dataFrame.shape[0]):
                if dataFrame.at[i,0] == 1:
                    ax.scatter(dataFrame.at[i,1],dataFrame.at[i,2],dataFrame.at[i,3],marker='o')
                elif dataFrame.at[i,0] == -1:
                    ax.scatter(dataFrame.at[i,1],dataFrame.at[i,2],dataFrame.at[i,3],marker='^')
